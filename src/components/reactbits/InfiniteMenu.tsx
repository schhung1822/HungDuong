...
const InfiniteMenu: FC<InfiniteMenuProps> = ({ items = [], scale = 1.0 }) => {
  ...
  const handleButtonClick = () => {
    ...
    if (activeItem.link.startsWith('http')) {
      ...
      window.location.hash = activeItem.link.startsWith('#') ? activeItem.link.slice(1) : activeItem.link;
    }
  };
    ...
    <div className="relative w-full h-full">
      ...
      {activeItem && (
        <>
          ...
          ${
            isMoving
              ? 'opacity-0 pointer-events-none duration-[100ms] -translate-y-2 md:translate-y-[-45%]'
              : 'opacity-100 pointer-events-auto duration-[500ms] translate-y-0 md:translate-y-[-50%]'
          }
        `}
          >
          ...
          <button
            ...
            aria-label={`Xem dự án ${activeItem.title}`}
            className={`
          absolute
          left-1/2
          top-[86%]
          ...
          ${
            isMoving
              ? 'opacity-0 pointer-events-none scale-75 duration-[100ms]'
              : 'opacity-100 pointer-events-auto scale-100 duration-[500ms]'
          }
        `}
          >
            &#x2197;
          ...
          ${
            isMoving
              ? 'opacity-0 pointer-events-none duration-[100ms] translate-y-4 md:translate-y-[-45%]'
              : 'opacity-100 pointer-events-auto duration-[500ms] translate-y-0 md:translate-y-[-50%]'
          }
        `}
          >
